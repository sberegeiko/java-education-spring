...
public class ContactSummaryServiceImpl implements ContactSummaryService {
    ...
    public List<ContactSummary> findAll() {
        List<ContactSummary> result = em.createQuery("select new by.beregeiko.jpa.ContactSummary(" +
                "c.firstName, c.lastName, t.telNumber) from Contact c left join c.contactTelDetails t " +
